...
class TicTacGame:
    ...
    def switch_player(self):
        self.player = (
            self.PLAYER_1 if self.player == self.PLAYER_2 else self.PLAYER_2
        )
    ...
    def start_game(self, n=3):
        ...
        while not winner:
            ...
            if (
                move_count == self.board_size * self.board_size
                and winner == self.NO
            ):
                winner = self.DRAW
            ...
            for j in range(y - 2, y + 1):
                ...
                try:
                    if (
                        ...
                        and self.board[j][i + 1] == self.board[j][i + 2]
                        and self.board[j][i] != " "
                    ):
                ...
                try:
                    if (
                        ...
                        and self.board[j + 1][i] == self.board[j + 2][i]
                        and self.board[j][i] != " "
                    ):
                        return self.board[j][i]
                except IndexError:
                ...
                try:
                    if (
                        self.board[j][i] == self.board[j + 1][i + 1]
